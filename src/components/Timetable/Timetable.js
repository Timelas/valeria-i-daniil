  ...
  return (
    <section className="timetable" id="plan">
      ...
      <div className="timetable__block">
        ...
        <p className="timetable__text timetable__text_about_rings">Сбор гостей в 14:30</p>
        <p className="timetable__text timetable__text_about_foto">Фотосессия с гостями<br />17:00</p>
        <p className="timetable__text timetable__text_about_glasses">Welcome 16:45</p>
        <p className="timetable__text timetable__text_about_plate">Свадебный ужин <br /> 18:00</p>
